...
namespace KuaforApi.Migrations
{
    ...
    [Migration("20260602182101_AddMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KuaforApi.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KuaforApi.Models.MessageThread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SalonId", "CustomerId", "Type")
                        .IsUnique();
            ...
            modelBuilder.Entity("KuaforApi.Models.ChatMessage", b =>
                {
                    b.HasOne("KuaforApi.Models.MessageThread", "MessageThread")
                        .WithMany("Messages")
                        .HasForeignKey("MessageThreadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KuaforApi.Models.User", "Sender")
                        .WithMany()
