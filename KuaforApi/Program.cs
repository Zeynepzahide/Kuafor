...
static void RepairRenderSchema(AppDbContext db)
{
    db.Database.ExecuteSqlRaw("""
        ...
        CREATE TABLE IF NOT EXISTS "MessageThreads" (
            ...
            CONSTRAINT "FK_MessageThreads_Salons_SalonId"
                FOREIGN KEY ("SalonId") REFERENCES "Salons" ("Id") ON DELETE CASCADE,
            CONSTRAINT "FK_MessageThreads_Users_CustomerId"
        ...
        CREATE TABLE IF NOT EXISTS "ChatMessages" (
            ...
            CONSTRAINT "FK_ChatMessages_MessageThreads_MessageThreadId"
                FOREIGN KEY ("MessageThreadId") REFERENCES "MessageThreads" ("Id") ON DELETE CASCADE,
            CONSTRAINT "FK_ChatMessages_Users_SenderId"
                FOREIGN KEY ("SenderId") REFERENCES "Users" ("Id") ON DELETE RESTRICT
        );

        ALTER TABLE IF EXISTS "MessageThreads"
        ...
        UPDATE "MessageThreads"
            ...
            WHERE "Type" = 'Inquiry'
              AND EXISTS (
                  ...
                  WHERE "Appointments"."SalonId" = "MessageThreads"."SalonId"
                    AND "Appointments"."CustomerId" = "MessageThreads"."CustomerId"
              );
        DROP INDEX IF EXISTS "IX_MessageThreads_SalonId_CustomerId";
        CREATE UNIQUE INDEX IF NOT EXISTS "IX_MessageThreads_SalonId_CustomerId_Type"
            ON "MessageThreads" ("SalonId", "CustomerId", "Type");
        CREATE INDEX IF NOT EXISTS "IX_MessageThreads_CustomerId"
            ON "MessageThreads" ("CustomerId");
        CREATE INDEX IF NOT EXISTS "IX_ChatMessages_MessageThreadId"
            ON "ChatMessages" ("MessageThreadId");
        CREATE INDEX IF NOT EXISTS "IX_ChatMessages_SenderId"
