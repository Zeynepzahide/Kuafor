...
class AuthService {
  ...
  Future<String?> login(
    ...
    try {
      ...
      print(
          'LOGIN URL: ${e.requestOptions.uri}');
      return null;
    } catch (e) {
  ...
  Future<bool> register({
    ...
    try {
      final data = <String, dynamic>{
        ...
        if (salonLatitude != null)
          'salonLatitude': salonLatitude,
        if (salonLongitude != null)
      ...
      print(
          'REGISTER BODY: ${response.data}');

      return response.statusCode == 200 ||
          response.statusCode == 201;
    } on DioException catch (e) {
      print(
          'REGISTER ERROR TYPE: ${e.type}');
      print(
          'REGISTER STATUS: ${e.response?.statusCode}');
      print(
          'REGISTER DATA: ${e.response?.data}');
      print(
          'REGISTER MESSAGE: ${e.message}');
      print(
          'REGISTER URL: ${e.requestOptions.uri}');
      return false;
    } catch (e) {
  ...
  Future<Map<String, dynamic>?> getUserInfo(
    ...
    try {
      ...
      print(
          'Kullanıcı bilgisi genel hata: $e');
      return null;
    }
  }
  ...
  Future<String?> uploadProfilePhoto({
    ...
    try {
      ...
      print(
          'UPLOAD PHOTO ERROR: ${e.response?.data}');
      return null;
    } catch (e) {
      print(
          'UPLOAD PHOTO GENERAL ERROR: $e');
      return null;
    }
  }
